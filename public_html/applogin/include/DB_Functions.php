...
class DB_Functions {
     ...
     */
    public function storeUser($name, $userid, $password, $birth, $sex, $phonenumber) {
        $uuid = uniqid('', true);
        $hash = $this->hashSSHA($password);
        $encrypted_password = $hash["encrypted"]; // encrypted password
        $salt = $hash["salt"]; // salt

        $stmt = $this->conn->prepare("INSERT INTO users(unique_id, userid, name, birth, encrypted_password, salt, sex, phonenumber)
            VALUES('$uuid', '$userid','$name', '$birth', '$encrypted_password', '$salt', '$sex', '$phonenumber')");
